...
----- | ----------- | ---------
[0-add_integer.py](./0-add_integer.py) | Python function that adds 2 integers | `def add_integer(a, b=98):`
[2-matrix_divided.py](./2-matrix_divided.py) | Python function that divides all elements of a matrix | `def matrix_divided(matrix, div):`
